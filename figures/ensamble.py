...
population = erg.multiplicative_perturbed_history(n=1000,iterations=50,rate=1.05,dt=1/12,sigma=2)
...
plt.savefig(name+"_1.pdf",pad_inches =0,transparent =True)
plt.savefig(name+"_1.png",pad_inches =0,transparent =True,dpi=90)
...
plt.ylabel("Wealth (log scale)", fontsize=16 )
plt.xlabel("Time", fontsize=16 )
plt.savefig(name+"_2.pdf",pad_inches =0,transparent =True)
plt.savefig(name+"_2.png",pad_inches =0,transparent =True,dpi=90)
...
plt.ylabel("Wealth (log scale)", fontsize=16 )
plt.xlabel("Time", fontsize=16 )
plt.savefig(name+"_3.pdf",pad_inches =0,transparent =True)
plt.savefig(name+"_3.png",pad_inches =0,transparent =True,dpi=90)
...
erg.perturbed_payment(rate=1.05,dt=1/12,sigma=5)
